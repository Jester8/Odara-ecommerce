...
const ProductSkeleton = () => (
  <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 2xl:w-1/6 flex-shrink-0 p-0.5">
        ...
        <div className="flex transition-transform duration-300 ease-in-out gap-0"
          ...
          {isLoading
            ...
            : products.map((product) => (
                <div key={product.id} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 2xl:w-1/6 flex-shrink-0 p-0.5">
