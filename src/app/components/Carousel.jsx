  ...
  const Carousel = ({ products = [] }) => {
    ...
    return (
      <div className="relative w-full h-[400px] overflow-hidden flex hidden md:flex">
  ...
  const PhoneCarousel = () => {
    const phones = [
      { id: 1, name: "iPhone 5", price: "$199", imageUrl: "https://picsum.photos/id/1/300/150" },
      { id: 2, name: "iPhone 6", price: "$299", imageUrl: "https://picsum.photos/id/2/300/150" },
      { id: 3, name: "iPhone 7", price: "$399", imageUrl: "https://picsum.photos/id/3/300/150" },
      { id: 4, name: "iPhone 8", price: "$499", imageUrl: "https://picsum.photos/id/4/300/150" },
      { id: 5, name: "iPhone X", price: "$599", imageUrl: "https://picsum.photos/id/5/300/150" },
      { id: 6, name: "iPhone 11", price: "$699", imageUrl: "https://picsum.photos/id/6/300/150" },
      { id: 7, name: "iPhone 12", price: "$799", imageUrl: "https://picsum.photos/id/7/300/150" },
      { id: 8, name: "iPhone 13", price: "$899", imageUrl: "https://picsum.photos/id/8/300/150" },
      { id: 9, name: "iPhone 14", price: "$999", imageUrl: "https://picsum.photos/id/9/300/150" },
      { id: 10, name: "iPhone 15", price: "$1099", imageUrl: "https://picsum.photos/id/10/300/150" },
      { id: 11, name: "iPhone 16", price: "$1199", imageUrl: "https://picsum.photos/id/11/300/150" },
    ];
      ...
      <div className="block sm:hidden mt-4">
        <div className="w-full overflow-x-auto scrollbar-hide">
          <div className="flex space-x-4 p-2" style={{ width: 'max-content' }}>
            {phones.map((phone) => (
              <div key={phone.id} className="flex-shrink-0" style={{ width: '255px', height: '14  5px' }}>
                <div className="relative w-full h-full">
                  <Image
                    src={phone.imageUrl}
                    alt={phone.name}
